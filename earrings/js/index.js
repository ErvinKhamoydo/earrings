...
/* harmony import */ var _modules_testWebp__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/testWebp */ "./#src/js/modules/testWebp.js");
...
window.addEventListener('DOMContentLoaded', function () {
  Object(_modules_testWebp__WEBPACK_IMPORTED_MODULE_0__["default"])(function (support) {
    if (support == true) {
  ...
  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_1__["default"])('.main-home-slider-body-slides-item', '.slider-body-btns-item-prev', '.slider-body-btns-item-next', '.slider-body-navslides-item');
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.main-home-info-timer-wrapper-timer', '2020-12-31');
});
...
var sliders = function sliders(slides, prev, next, navSlides) {
  var slideIndex = 1;
  var paused = false;
  var items = document.querySelectorAll(slides);
  var navSlide = document.querySelectorAll(navSlides);
  ...
  try {
    ...
    prevBtn.addEventListener('click', function () {
      ...
      navSlide.forEach(function (item) {
    ...
    navSlide.forEach(function (item, index) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return TestWebP; });
